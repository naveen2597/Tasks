...
export class LoginComponent implements OnInit {
  ...
  this.router.navigateByUrl('Login-page')}
    ...
    //GET IMAGE FORM CLOUDINARY AND LIST OF IMAGES IN SERVER
    imgUrl: string = 'https://res.cloudinary.com/dmesgafph/image/upload/v1623833403/d2kcfmakhmtkihnlm2yr.jpg';
    ...
    createImageFromBlob(image: Blob) {
     ...
     getImageFromService() {
      ...
      this.luser.getImage(this.imgUrl).subscribe(data => {
